...
import websiteLogo from '../../public/images/logos/Header Logo.svg';
  ...
  return (
    <Navbar collapseOnSelect expand="lg" bg="none" variant="light">
      <Container fluid>
        ...
        <Link href="/" className="navbar-brand"> <Image className="img-fluid header_logo" src={websiteLogo} alt="Header Logo" /> </Link>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" />
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto">
            <Link href="/courses" className="nav-link"> Courses </Link>
            <Link href="/coding-for-kids" className="nav-link"> Coding For Kids </Link>
            <Link href="/competitions" className="nav-link"> Competition </Link>
            <Link href="/quizes" className="nav-link"> Quizes </Link>
            <NavDropdown title="Courses">
              <Link href="/courses/scratch-programming" className="nav-link"> Scratch Programming </Link>
              <Link href="/courses/react-js" className="nav-link"> React JS </Link>
            </NavDropdown>
          </Nav>
          <Nav className="ms-auto">
            <Link href="/courses" className="nav-link"> 
            <span className="border px-2 language_button">
            ...
            <Link href="/free-class-request" className="nav-link"> Try Free Class </Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
